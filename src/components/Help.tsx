...
const Help = ({ visible }: { visible: boolean }) => (
  <div className={`z-10 absolute right-0 top-3 font-medium bg-background-600 text-foreground p-3 rounded-r-lg w-[44ch] whitespace-normal translate-x-[100%] ${visibility(visible)}`}>
