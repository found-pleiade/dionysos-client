...
const Help = ({ visible }: { visible: boolean }) => (
  <div className={`z-10 absolute right-0 top-3 font-medium dark:bg-dark-primary-600/80 dark:text-dark-secondary p-3 rounded-r-lg w-[44ch] whitespace-normal translate-x-[100%] ${visibility(visible)}`}>
    ...
    <br />
    <h1 className="font-bold text-xl dark:text-dark-secondary/90">Create a room</h1>
    <p className="dark:text-dark-secondary/70">
    ...
    <br />
    <h1 className="font-bold text-xl dark:text-dark-secondary/90">Join a room</h1>
    <p className="dark:text-dark-secondary/70">
