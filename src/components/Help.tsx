...
const Help = ({ visible }: { visible: boolean }) => (
  <div className={`z-10 absolute right-0 top-3 font-medium bg-light-primary-200/80 dark:bg-dark-primary-600/80 text-light-secondary dark:text-dark-secondary p-3 rounded-r-lg w-[44ch] whitespace-normal translate-x-[100%] ${visibility(visible)}`}>
